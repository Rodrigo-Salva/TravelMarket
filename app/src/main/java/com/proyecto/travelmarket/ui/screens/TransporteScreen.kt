...
import com.proyecto.travelmarket.ui.viewmodel.TransporteViewModel
...
fun TransporteScreen(
    ...
    val transportes by viewModel.transportes.collectAsState()
        ...
        Column(
            ...
            Row(
                ...
                Column {
                    ...
                    Text(
                        text = "🗺️ ${transporte.ruta}",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.secondary
                    )
                    Text(
                        text = "🕐 ${transporte.horario}",
                        style = MaterialTheme.typography.bodySmall,
                        color = MaterialTheme.colorScheme.secondary
                    )
                }
